...
import model from '../models/customers.js';
...
const controller = {
    post: async (req, res) => {
        ...
        try {
            ...
            const token = jsonwebtoken.sign({
                random, name, lastname, birthdate, email, password: hash, isVerified
            }, config.jwt.secret, {
                expiresIn: '15m'
            });
    ...
    verify: async (req, res) => {
        try {
            ...
            const {
                random, name, lastname, birthdate, email, password, isVerified
            } = decoded;
